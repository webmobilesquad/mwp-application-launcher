  ...
  render(props, { modalVisible }) {
    return (
      <div className={style.ApplicationLauncherButtonWrapper} {...props}>
        <button type="button" className={style.ApplicationLauncherButton} onClick={this.showModal}>
        ...
        <ApplicationLauncherModal visible={modalVisible} onClose={this.hideModal} />
      </div>
    );
  }
}
